...
public class Application {
    ...
    public static void startContainer(int port) throws ServletException {
        ...
        servletBuilder
                ...
                .setContextPath("/user-management")
                .setDeploymentName("user-management.war")
        ...
        manager.deploy();
        PathHandler path = Handlers.path(Handlers.redirect("/user-management"))
                .addPrefixPath("/user-management", manager.start());
